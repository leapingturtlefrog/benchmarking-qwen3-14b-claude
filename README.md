...
Evaluation of whether distilling 250 chain-of-thought examples from Claude 4.5 Opus into Qwen3-14B improves performance across math, coding, and instruction-following benchmarks.
...
|---|---|---|---|---|
| HumanEval+ (coding) | **83.5%** | 55.5% | **+28.0pp** | p < 10^-9 (***) |
| IFEval (instruction following) | **77.3%** | 63.6% | **+13.7pp** | p < 10^-7 (***) |
| AIME 2024 (competition math) | 56.7% | **70.0%** | -13.3pp | p = 0.344 (ns) |
| AIME 2025 (competition math) | 43.3% | **66.7%** | -23.4pp | p = 0.039 (*) |
